...
## Optional jsoup RE2J integration (not included on Android)
-dontwarn com.google.re2j.**

## ICU4J dev-tools (doc processing), not needed at runtime
-dontwarn com.sun.source.doctree.**
-dontwarn com.ibm.icu.dev.**
